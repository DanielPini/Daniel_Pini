...
export default class Metronome {
  ...
  attachEventListeners() {
    ...
    (_e = this.repertoireSelector) === null || _e === void 0
      ? void 0
      : _e.addEventListener("input", () => {
          this.updateRepertoireSelector();
          this.generateRepertoireTempoButtonsArray();
        });
    (_f = this.repertoireSelectorTemposContainer) === null || _f === void 0
      ? void 0
      : _f.addEventListener("click", (e) => {
          ...
          if (tempoButton) {
            const bpm =
              (_a = tempoButton.querySelector("p")) === null || _a === void 0
                ? void 0
                : _a.textContent;
  ...
  generateRepertoireTempoButtonsArray() {
    var _a;
    this.repertoireTempoArray = (
      (_a = this.repertoireSelectorTemposContainer) === null || _a === void 0
        ? void 0
        : _a.children
    )
  ...
  updateRepertoireSelector() {
    var _a;
    this.selectedPiece = Number(
      (_a = this.repertoireSelector) === null || _a === void 0
        ? void 0
        : _a.selectedIndex
    );
    this.renderTempoList();
